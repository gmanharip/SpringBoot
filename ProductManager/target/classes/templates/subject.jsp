...
<form:form method="POST"
   action="subjectAdd" modelAttribute="subjectForm">
      <table>
      	<tr>
             <td><div class="input-group-prepend"><form:label class="input-group-text" path="subjectId">subjectId</form:label></div></td>
             <td><form:input class="form-control" placeholder="Add Subject ID" path="subjectId"/></td>
         </tr>
         <tr>
         ...
         <tr>
             <td><div class="input-group-prepend"><form:label class="input-group-text" path="durationInHours">durationInHours</form:label></div></td>
             <td><form:input class="form-control" placeholder="Add Subject Duration in Hours" path="durationInHours"/></td>
         </tr>
         <tr>
